...
def ref(*args, **kwargs):
    refs = {"raw_pos_location": "DBT_DEMO_DB.dev.raw_pos_location", "raw_pos_order_header": "DBT_DEMO_DB.dev.raw_pos_order_header", "raw_pos_truck": "DBT_DEMO_DB.dev.raw_pos_truck"}
    key = '.'.join(args)
...
class this:
    ...
    def __repr__(self):
        return 'DBT_DEMO_DB.dev.sales_metrics_by_location'
